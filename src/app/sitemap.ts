...
const STATIC_PATHS: MetadataRoute.Sitemap = [
  ...
  { url: `${SITE_ORIGIN}/products/kpis-tracker`, changeFrequency: "monthly", priority: 0.85 },
  { url: `${SITE_ORIGIN}/products/report-builder`, changeFrequency: "monthly", priority: 0.9 },
