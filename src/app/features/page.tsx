...
const PAGE_DESCRIPTION =
  "Explore Conalytic features: AI marketing chat for GA4, Google Ads, Search Console, GTM, and Meta; KPI goal tracking dashboard; automated HTML client report decks. Natural-language analytics, OAuth integrations, token-based Pro.";
