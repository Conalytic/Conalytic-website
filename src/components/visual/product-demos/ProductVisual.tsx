...
export function BlogCardVisual({ variant, demoVariant }: BlogVisualProps) {
  return (
    <div className="relative aspect-[16/9] w-full overflow-hidden bg-brand-900">
      <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(ellipse_70%_60%_at_50%_50%,var(--demo-section-glow),transparent_70%)]" />
...
export function BlogArticleHeroVisual({ variant, demoVariant }: BlogVisualProps) {
  return (
    <div className="relative aspect-[5/4] w-full overflow-hidden rounded-2xl border border-white/[0.08] bg-brand-900 shadow-xl shadow-black/40 sm:aspect-[4/3] lg:aspect-auto lg:min-h-[280px]">
      <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(ellipse_70%_60%_at_50%_50%,var(--demo-glow),transparent_70%)]" />
...
export function BlogFeaturedVisual({ variant, demoVariant }: BlogVisualProps) {
  return (
    <div className="relative min-h-[220px] w-full overflow-hidden bg-brand-900 lg:min-h-[320px]">
      <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(ellipse_70%_60%_at_50%_50%,var(--demo-glow),transparent_70%)]" />
